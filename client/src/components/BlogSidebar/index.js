                    ...
                    <div className="posts">
                        <div className="post">
                            ...
                            <div className="details">
                                <h4><Link to='/Blog-details'>Recent post 1 mock</Link></h4>
                            </div>
                        </div>
                        <div className="post">
                            <div className="img-holder">
                            ...
                            <div className="details">
                                <h4><Link to='/Blog-details'>Recent post 2 mock</Link></h4>
                            </div>
                        </div>
                        <div className="post">
                            <div className="img-holder">
                            ...
                            <div className="details">
                                <h4><Link to='/Blog-details'>Recent post 3 mock</Link></h4>
                            </div>
                        </div>
                    </div>
                </div>
